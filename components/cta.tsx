      ...
      <div className="container-wide">
        ...
        <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-ink-900 via-ink-900 to-ink-800 p-10 sm:p-16 overflow-hidden">
          <div className="pointer-events-none absolute inset-0 hidden md:block">
            <div className="absolute -top-24 -right-24 h-[420px] w-[420px] rounded-full bg-brand-500/20 blur-3xl" />
            <div className="absolute -bottom-24 -left-24 h-[360px] w-[360px] rounded-full bg-violet-500/20 blur-3xl" />
          </div>
